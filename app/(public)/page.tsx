...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      ...
      <header className="bg-white/90 backdrop-blur-sm border-b border-slate-200 shadow-sm">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/echipa"
              className="text-sm text-rose-500 hover:text-rose-700 font-medium transition-colors flex items-center gap-1"
            >
      ...
      {/* Hero */}
      <section id="main-content" className="max-w-3xl mx-auto px-4 pt-10 pb-6 text-center">
