  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none" aria-hidden="true">
      ...
      >
        ...
        <g stroke="#f43f5e" strokeWidth="2" fill="none" opacity="0.08">
        ...
        <g stroke="#f43f5e" strokeWidth="3" fill="none" opacity="0.06">
        ...
        <g stroke="#f43f5e" strokeWidth="1.5" fill="none" opacity="0.05">
