...
function Toggle({
  ...
  return (
    <button
      ...
      onClick={onToggle}
      disabled={disabled}
      className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-1 disabled:opacity-40 disabled:cursor-not-allowed ${
        activ ? "bg-blue-600" : "bg-slate-300"
      }`}
    >
      <span
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-lg border border-slate-300 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-300 transition-colors"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2.5 rounded-lg border border-slate-300 text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-300 transition-colors bg-white"
            >
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              type="submit"
              disabled={pending}
              className="flex-1 py-2.5 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-lg border border-slate-300 text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-300 transition-colors"
            />
          </div>
    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-4">
        <input
          ...
          className="flex-1 px-4 py-2.5 rounded-lg border border-slate-300 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-300 text-sm"
        />
        <select
          value={filtruRol}
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors text-sm shrink-0"
        >
