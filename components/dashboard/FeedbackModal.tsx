                ...
                <div className="flex-1 px-6 pt-5 pb-4 flex flex-col gap-4 overflow-auto">
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <textarea
                      ...
                      className="flex-1 w-full px-4 py-3 rounded-xl border border-slate-300 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-300 text-sm resize-none leading-relaxed"
                      disabled={stare === "loading"}
                    />
