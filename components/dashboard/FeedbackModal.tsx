  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center gap-1.5 text-sm text-slate-500 hover:text-rose-400 transition-colors px-3 py-1.5 rounded-lg hover:bg-rose-50"
              ...
              <form onSubmit={trimite} className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="px-6 py-4 border-t border-slate-200 flex items-center justify-end gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2 bg-rose-400 text-white text-sm font-medium rounded-lg hover:bg-rose-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    {stare === "loading" ? (
                      <>
